  ...
  app.post(
    ...
    async (req, res) => {
      ...
      try {
        ...
        const gen_request_id = `${req.company.code}-BUREAU-SCORECARD-${Date.now()}`;
      ...
      const createdLogs =  await createLog(
        ...
        await BureauScorecards.updateBureauResponse(gen_request_id, responseUrl.raw_data);
          CommonBureauMapper(req.body.loan_app_id, req.body.bureau_type, req.body.partner_id, resData, (err, bureauMapperRes)=>{
            if(err){
