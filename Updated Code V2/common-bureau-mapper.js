...
module.exports.CommonBureauMapper = async (customerId,bureau,partnerName,response,callback)=>{
...
module.exports.CommonBureauMapper_v2 = async (customerId,bureau,company_id,response,loan_amount,loan_tenure,product_type,request_id,callback)=>{
    try{
