    ...
    app.post(
        ...
        async (req, res) => {
            try {
                ...
                if (!["STPL", "PRLN", "AUTO", "LAPY", "SMSM", "UMSM", "UBLN", "SBLN", "CNDL", "EDLN", "SCFN"].includes(req.body.product_type))
                    throw {
                ...
                if (bureauResponse && bureauResponse.data) {
                    ...
                    CommonBureauMapper(req.body.loan_app_id, req.body.bureau_type, req.body.partner_id, resData, gen_request_id, (err, bureauMapperRes) => {
                        if (err) {
